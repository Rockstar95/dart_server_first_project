...
abstract class DatePresentation {
  ...
  static String yyyyMMddHHmmssFormatter(DateTime timeStamp) {
    DateTime dateTime = timeStamp;
    return DateFormat('yyyy-MM-dd HH:mm:ss').format(dateTime);
  }

  static String yyyyMMddFormatter(DateTime timeStamp) {
    DateTime dateTime = timeStamp;
  ...
  static String EEEddMMMMyyhhmmaFormatter(DateTime date){
    String formattedDate = DateFormat('EEE dd, MMMM yy – hh:mm a').format(date);
